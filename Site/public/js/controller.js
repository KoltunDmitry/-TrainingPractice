(function() {
    ...
    function btnAddPost() {
        ...
        btnAddPost.addEventListener("click", function () {
            ...
            let post = {
                ...
                author: DOM.getUser(),
                photoLink: url,
                hashTag: model.makeArrayHashtagsFromString(hashtags),
                like: [],
                isDelete: false
            };
    ...
    sign.addEventListener("click", function () {
        var result = users.isCorrectLoginPassword(
    ...
    filtering.addEventListener('click', function () {
        ...
        if (date.length !== 0) {
            var dateArray = model.splitDate(date);
            DOM.showPosts(0, 10, {
                author: author,
    ...
    function btnEditPost(id) {
        ...
        btnEditPost.addEventListener('click', function () {
            ...
            var post = {
                ...
                hashTag: model.makeArrayHashtagsFromString(hashtagsStr),
            };
